  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="1,247" label="Decisions Captured" delay={500} />
        <ScrambleNumber target="95.3%" label="Context Accuracy" delay={800} />
        <ScrambleNumber target="38" label="Engineers Onboarded" delay={1100} />
        <ScrambleNumber target="4.2h" label="Avg Time Saved / Day" delay={1400} />
      </div>
    </div>
  );
}
