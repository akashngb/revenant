    ...
    >
      ...
      <Link href="/" className="flex items-center gap-2 shrink-0">
        <div className="relative w-8 h-8 rounded-lg overflow-hidden">
          <Image src="/logo.png" alt="Revenent" fill sizes="32px" className="object-contain" />
        </div>
        <span className="text-[#e8e0d0] font-semibold text-base tracking-tight">Revenent</span>
      </Link>
